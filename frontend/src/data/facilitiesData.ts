...
export const DEMO_FACILITIES: IndustrialFacility[] = [
  ...
  },
  {
    ...
    associatedEventId: 'EVT-2041',
    proximity_km: 0.5,
    status: 'Continuous Heavy Emitter',
  },
  {
    id: 'FAC-DHN-01',
    name: 'BCCL Coal Washery & Extraction Complex',
    type: 'Coal Processing & Rail Loadout Facility',
    category: 'Steel & Metallurgical',
    lon: 86.425,
    lat: 23.755,
    osm_id: 'osm-node-93019299',
    associatedEventId: 'EVT-1405',
    proximity_km: 0.7,
    status: 'Continuous Heavy Emitter',
  },
  {
  ...
  },
  {
    ...
    associatedEventId: 'EVT-2219',
    proximity_km: 0.9,
    status: 'High Hazard Tier 1',
  },
  {
    id: 'FAC-BLY-01',
    name: 'JSW Vijayanagar Integrated Steel Complex',
    type: 'Slag Yard & Integrated Blast Furnace',
    category: 'Steel & Metallurgical',
    lon: 76.654,
    lat: 15.223,
    osm_id: 'osm-node-96019287',
    associatedEventId: 'EVT-0842',
    proximity_km: 0.4,
    status: 'Operational',
  },
];
